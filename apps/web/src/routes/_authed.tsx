    ...
    <div className="flex min-h-screen flex-col bg-ground">
      <div className="flex h-14 flex-shrink-0 items-center gap-8 border-b border-border bg-surface px-8">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link to="/currency" className={navItemClass} activeProps={{ className: navItemActiveClass }}>
            Currency
          </Link>
        ...
        <Link
          ...
          activeProps={{ className: 'flex items-center gap-2.5 text-sm text-ink hover:text-ink' }}
        >
        ...
        <button onClick={handleSignOut} className="text-sm text-ink-dim hover:text-ink">
          Sign out
        </button>
      </div>
