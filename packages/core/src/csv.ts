...
export const CSV_HEADER_ALIASES: Record<CsvColumnKey, ReadonlyArray<string>> = {
  ...
  tailNumber: ['Tail Number', 'Registration', 'Ident'],
  ...
  dualTime: ['Dual', 'Dual Received'],
  soloTime: ['Solo', 'Solo Time'],
  nightTime: ['Night', 'Night Time'],
  actualInstrument: ['Actual Instrument', 'Actual Inst', 'IMC'],
  simInstrument: ['Simulated Instrument', 'Sim Instrument', 'Hood'],
